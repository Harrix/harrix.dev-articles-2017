...
В отличии от статьи [Сложение двух чисел в HTML с передачей параметров через POST](/blog/2017/add-2-num-php-post/) сервер в качестве ответа формирует JSON файл.
