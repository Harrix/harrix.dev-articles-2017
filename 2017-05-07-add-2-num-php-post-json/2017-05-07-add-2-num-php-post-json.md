...
В отличии от статьи [Сложение двух чисел в HTML с передачей параметров через POST](/blog/2015/add-2-num-php-post/) сервер в качестве ответа формирует JSON файл.
...
По сравнению со статьей [Сложение двух чисел в HTML с передачей параметров через POST](/blog/2015/add-2-num-php-post/) тут строчка `echo $c;` поменялась на следующие строчки:
...
Закидываем данный скрипт на сервер. Я закинул на <https://harrix.dev/blog/2017/add-2-num-php-post-json/demo/>
