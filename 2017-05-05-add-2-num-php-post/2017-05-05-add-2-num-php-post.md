...
В [статье](/blog/2017/add-2-num-php-get/) рассматривается вариант с GET запросом.
...
Закидываем данный скрипт на сервер. Я закинул на <https://harrix.dev/blog/2017/add-2-num-php-post/demo/>
